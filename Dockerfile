FROM debian:7.8
MAINTAINER Steele Nelson steele@elytics.com

ENV \
    ZK_RELEASE="http://www.apache.org/dist/zookeeper/zookeeper-3.4.11/zookeeper-3.4.11.tar.gz" \
    EXHIBITOR_POM="https://raw.githubusercontent.com/soabase/exhibitor/exhibitor-1.7.0/exhibitor-standalone/src/main/resources/buildscripts/standalone/maven/pom.xml" \
